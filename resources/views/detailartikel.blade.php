...
@section('container')
    ...
    <div class="container-pub">
        <div class="col">
            <a href="/artikel" class="back"><i class="bi bi-chevron-left"></i> Kembali ke Artikel</a>
        </div>
        <div class="col">
                        ...
                        <div class="col-md-4">
                            <div class="container-pub-left">
                                <div class="col" style="padding: 10%;border-bottom: 0.5px solid #979797 ">
                                    <img class="img-detail-pub" src="{{ $artikel['media'][0]['MDFPATH'] }}" alt="..."
                                        alt="">
                                </div>
                                ...
                                <div class="col margin-img-desc-left" style="height: 60px;">
                                    <span class="txt-desc-pub"><i class="bi bi-calendar2 icon-desc"></i>
                                        {{ tgl_indo(substr($artikel['CREATED'], 0, 10)) }}</span>
                                </div>
                            </div>
                        </div>
    ...
    <div class="rekomendasi">
        ...
        <div class="col gap-4 rekomendasi-group mb-4">
            @foreach (array_slice($randomData, 0, 6) as $a)
                <?php
                $key = array_search($a['ARID'], array_column($allartikel['data'], 'ARID'));
                ?>
                <a href="/publikasi/{{ $key }}">
                    <div class="card-rekomendasi card" style="width: 13rem;">
                        ...
                        <div class="mt-3">
                            <h5 class="card-title-rekom">{{ substr($a['ARJUDUL'], 0, 40) }}...</h5>
